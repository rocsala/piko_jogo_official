...
import 'package:piko_jogo/games/hangman/http/random_word.dart';
import 'package:piko_jogo/games/hangman/screens/win_screen.dart';
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: Center(
                            child: Image.asset(
                              'assets/hangman/${10 - game.lives}.png',
                            ),
                          ),
                        ),
                        SizedBox(
  ...
  Future getWord(BuildContext context) async {
    try {
      ...
      setState(() {
        ...
        guessedLetters.forEach((element) => element.title == " "
