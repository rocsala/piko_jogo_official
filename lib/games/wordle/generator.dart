...
Future<Set<String>> generateDictionary() async {
  ...
  String dicContents = await rootBundle.loadString("assets/wordle/All.txt");
  Set<String> database = {};
...
Future<Map<String, List<String>>> generateQuestionSet({String dicName, int wordLen}) async {
  // Directory documentRoot = await getApplicationDocumentsDirectory();
  // String dicPath = documentRoot.path + Platform.pathSeparator + dicName + ".txt";
  // File dicFile = File(dicPath);
  String dicContents = await rootBundle.loadString("assets/wordle/" + dicName + ".txt");
