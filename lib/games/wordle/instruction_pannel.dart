...
class DecoratedTitleWidget extends StatelessWidget {
  const DecoratedTitleWidget({this.title, Key key}) : super(key: key);
...
class DecoratedPlainText extends StatelessWidget {
  const DecoratedPlainText({this.text, Key key}) : super(key: key);
...
class DecoratedTextBox extends StatelessWidget {
  const DecoratedTextBox({this.letter, this.state, Key key}) : super(key: key);
...
Future<void> showInstructionDialog({context}) {
