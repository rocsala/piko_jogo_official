...
import 'package:piko_jogo/games/wordle/game_page.dart';
import 'package:piko_jogo/games/wordle/generator.dart';
import 'package:piko_jogo/games/wordle/validation_provider.dart';

class LoadingPage extends StatefulWidget {
  const LoadingPage({Key key, this.dicName, this.wordLen, this.maxChances, this.gameMode}) : super(key: key);
...
class _LoadingPageState extends State<LoadingPage> {
  Future<Map<String, List<String>>> _loadDatabase({String dicName, int wordLen, int gameMode}) async {
