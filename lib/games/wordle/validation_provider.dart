...
class InputNotification extends Notification {
  const InputNotification({this.type, this.msg});
...
class ValidationProvider extends StatefulWidget {
  ...
  const ValidationProvider({Key key, this.child, this.database, this.wordLen, this.maxChances, this.gameMode}) : super(key: key);
